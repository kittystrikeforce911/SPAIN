...
##IMPORTANT##
##IF THE NAMES ARE NOT THE SAME AS IN THIS SCRIPT IT ##
##WONT WORK,MAKE SURE THEY ARE NAMED CORRECTLY##
...
cd /home/usuario/.deb/LNCHRS/launcher-3;
cp -v -p *.desktop /home/usuario/.config/xfce4/panel/launcher-3/;
cd /home/usuario/.deb/LNCHRS/launcher-4;
